...
Root cause: /api/noxia/modules las aus KXF-Export (4 Records, veraltet). Fix: Route liest jetzt direkt aus learningPaths.ts (69 Pfade). CHE-WASSER-AUFBEREITUNG-0001 mit UNL:NOX:water-processing deployed.
