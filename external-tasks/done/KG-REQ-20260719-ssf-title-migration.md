...
4 Dateien migriert:
- lib/learning-modules.ts
- components/LearnMap/GraphView.tsx
- components/LearnMap/NodeCard.tsx
- components/LearnMap/DetailPanel.tsx

Fallback auf meta.title erhalten. KG kann meta.title entfernen.
Status: Done
