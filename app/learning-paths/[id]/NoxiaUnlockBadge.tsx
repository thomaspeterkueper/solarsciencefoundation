...
const NOXIA_KEY_INFO: Record<string, { label: string; description: string; icon: string }> = {
  ...
  'ISRU:WATER-EXTRACTION':   { icon: '💧', label: 'ISRU: Wasserextraktion',   description: 'Wasserextraktor-Bau freigeschaltet — Sublimationsverfahren aus Marsregolith (OTA-TEC-0034).' },
  'ISRU:REGOLITH-ANALYSIS':  { icon: '🔬', label: 'ISRU: Regolith-Analyse',   description: 'Analysiert Marsregolith auf Wassereis und Perchlorat — Standortbewertung fuer ISRU.' },
  'PHY:VACUUM-PHASE-DIAGRAM':{ icon: '📊', label: 'Vakuum-Phasendiagramm',   description: 'Versteht Phasenuebergaenge bei niedrigem Druck — Grundlage fuer alle ISRU-Systeme.' },
  'SENSOR:SUBSURFACE':       { icon: '📡', label: 'Untergrund-Scanner',       description: 'Erkennt Wassereis im Untergrund — Neutronenspektrometer-Technologie.' },
  'TOOL:DUST-MITIGATION':    { icon: '🧹', label: 'Staubschutz-Technik',      description: 'Mesh-Wheels, elektrische Felder, Beschichtungen gegen Mondstaub-Abrasion.' },
  'ENG:PRESSURE-CABIN':      { icon: '🔵', label: 'Druckkabinen-Technik',     description: 'Life-Support im Kleinformat — CO2-Filter, O2-Budget, Armstrong-Grenze.' },
  'NAV:SURFACE':             { icon: '🧭', label: 'Oberflaechennavigation',   description: 'Sternen, Gyros, Odometrie — Navigation ohne GPS auf dem Mond.' },
  'SENSOR:INERTIAL':         { icon: '⚡', label: 'Inertial-Sensor',          description: 'Gyroskop + Beschleunigungssensor fuer Dead-Reckoning-Navigation.' },
  ...
  'UNL:NOX:water-processing':  { icon: '💧', label: 'Wasseraufbereitung I',  description: 'Wasseraufbereitungs-Anlage baubar — Sedimentation, Filtration, Desinfektion, Recycling.' },
  'UNL:NOX:resource-extraction':{ icon: '⛏️', label: 'Rohstoffgewinnung I', description: 'Mine und Basis-Deposit-Gewinnung baubar — Abbau, Trennung, Aufbereitung.' },
  'BLD:NOX:wasseraufbereitung-1':{ icon: '🏭', label: 'Wasseraufbereitung Geb.', description: 'Gebäude: Wasseraufbereitungsanlage Stufe 1.' },
  'BLD:NOX:mine-1':             { icon: '⛰️', label: 'Mine Stufe 1',         description: 'Gebäude: Mine Stufe 1 — basale Rohstoffgewinnung.' },
