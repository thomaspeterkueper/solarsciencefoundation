...
export default async function GermanLearningPathDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="container reading" style={{ paddingTop: 56 }}>
      <p className="kicker">Lernpfad-Prototyp</p>
                ...
                <div key={section.id} style={{ border: '1px solid var(--border)', borderRadius: 12, padding: 14 }}>
                  <div className="module-meta">
                    ...
                    <span className="mono" style={{ color: 'var(--steel)', fontSize: 12 }}>
                      {section.optional ? 'optional' : 'main'} · Tiefe {section.depthPoints ?? 0}
                    </span>
                  </div>
