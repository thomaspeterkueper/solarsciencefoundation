  ...
  return <>
    <PlatformSectionLanding
      ...
      entries={[
        ...
        { eyebrow: 'Menschen', title: 'Autorinnen, Autoren und Beitragende', body: 'Die Stiftung ist für sichtbare Autorenschaft und mehrere Beitragende gedacht, nicht für anonyme Kursproduktion.', href: '/de/authors', cta: 'Autorinnen und Autoren kennenlernen →' },
    ...
    />
    <div className="container" style={{ paddingBottom: 88 }}><FoundationHighlights locale="de" /></div>
  </>;
}
