    ...
    <section className="subject-section" style={{ marginTop: 46 }}>
      <div className="platform-card" style={{ padding: 28, background: 'color-mix(in srgb, var(--steel) 6%, var(--paper))' }}>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          ...
          />
          <button type="button" onClick={checkAnswer} style={{ padding: '11px 18px', borderRadius: 999, border: 0, background: 'var(--steel)', color: 'white', fontWeight: 700, cursor: 'pointer' }}>
            Prüfen
          </button>
        </div>
