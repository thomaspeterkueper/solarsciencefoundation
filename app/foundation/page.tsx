  ...
  return <>
    <PlatformSectionLanding
      ...
      entries={[
        ...
        { eyebrow: 'People', title: 'Authors and contributors', body: 'The foundation is designed for visible authorship and multiple contributors rather than anonymous course production.', href: '/authors', cta: 'Meet the authors →' },
    ...
    />
    <div className="container" style={{ paddingBottom: 88 }}><FoundationHighlights locale="en" /></div>
  </>;
}
