  ...
  units: [
    {
      ...
      sections: [
        ...
        { id: 'EXP:CHE-KARAMELL:TEMP-TIME', kind: 'experiment', title: 'Temperatur × Zeit', summary: 'Verändere Temperatur und Zeit gemeinsam. Die Simulation zeigt qualitativ, dass Reaktionsfortschritt von beiden Größen abhängt und keine magische 160-°C-Grenze existiert.', interactive: true, depthPoints: 9 },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'EXP:CHE-KARAMELL:SUGAR-COMPARE', kind: 'experiment', title: 'Zucker unter gleichen Bedingungen vergleichen', summary: 'Vergleiche Fructose, Glucose und Saccharose bei gleicher Temperatur und Zeit. Die Anzeige vermittelt qualitative Unterschiede, ohne universelle Einzeltemperaturen zu erfinden.', interactive: true, depthPoints: 9 },
