    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          summary: 'Trübes Wasser enthält Partikel und Mikroorganismen. Welche Kombination adressiert beide Belastungsarten am direktesten?||Nur Sedimentation||Mechanische Filtration und anschließend Desinfektion*||Nur Aktivkohle||Nur ein grobes Sieb---Warum werden Filtration, Adsorption und Desinfektion unterschieden?||Weil jedes Verfahren gegen andere Belastungsarten wirkt*||Weil alle drei Verfahren ausschließlich Salze entfernen||Weil Desinfektion Sand mechanisch zurückhält||Weil Adsorption jedes Wasserproblem vollständig löst---Nach Filtration und Desinfektion wird zusätzlich eine problematische organische Spur festgestellt. Welches Prinzip ergänzt die Kette sinnvoll?||Sedimentation als universelle Entsalzung||Adsorption an einem geeigneten Material*||Ein größeres Partikelsieb als einzige Maßnahme||Keine weitere Behandlung, weil das Wasser klar ist',
          depthPoints: 5,
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          summary: 'Salzhaltiges Wasser soll entsalzt werden. Welches Verfahren passt zum Problem?||Ein grobes Sieb||Sedimentation allein||Umkehrosmose mit geeigneter Membran*||Nur mechanische Vorfiltration---Warum entfernt ein gewöhnlicher Partikelfilter gelöstes Salz nicht zuverlässig?||Gelöste Ionen sind nicht wie suspendierte Partikel mechanisch zurückzuhalten*||Salz ist immer gasförmig||Partikelfilter erhöhen automatisch den Salzgehalt||Gelöste Stoffe existieren nur in trübem Wasser---Eine Marsbasis entsalzt Wasser mit Umkehrosmose. Welche zusätzliche Systemfrage muss sie berücksichtigen?||Wie der konzentrierte Reststrom behandelt wird*||Wie Sand durch Desinfektion verdampft wird||Wie Adsorption jede Sole vollständig beseitigt||Wie ein grobes Sieb den nötigen Druck erzeugt',
          depthPoints: 5,
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          summary: 'Ein Rohwasser enthält Partikel, gelöste Salze und mögliche Mikroorganismen. Welche Kette ist als Lernmodell am plausibelsten?||Nur Desinfektion||Mechanische Vorbehandlung, Entsalzung und geeignete Desinfektionsbarriere*||Nur Aktivkohle||Nur Sedimentation---Was ist das zentrale Prinzip beim Entwurf einer Aufbereitungskette?||Möglichst jedes verfügbare Verfahren einsetzen||Verfahren passend zu Rohwasser, Zielqualität und verbleibenden Belastungen kombinieren*||Nur die sichtbare Klarheit maximieren||Restströme grundsätzlich ignorieren---Eine Marsbasis kann dieselbe Zielqualität mit zwei Prozessketten erreichen. Was sollte sie zusätzlich vergleichen?||Nur die Zahl der Ventile||Energiebedarf, Rückgewinnung und entstehende Restströme*||Nur die Farbe der Anlage||Nur die Länge der Rohrleitungen',
          depthPoints: 8,
        },
      ],
    },
