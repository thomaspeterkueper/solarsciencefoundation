    ...
    units: [
      {
        ...
        sections: [
          ...
          { id: 'EXERCISE:ECO-ZINSESZINS:CURVE-COMPARE', kind: 'exercise', title: 'Wachstumsverläufe vergleichen', summary: 'Berechne oder skizziere einfachen Zins und Zinseszins für denselben Anfangswert, Zinssatz und mehrere Perioden. Vergleiche, ab wann der Abstand deutlich wird.', depthPoints: 9 },
